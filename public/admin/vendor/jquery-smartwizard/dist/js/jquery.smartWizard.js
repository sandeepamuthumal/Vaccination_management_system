    ...
    var SmartWizard = /*#__PURE__*/ function() {
        ...
        _createClass(SmartWizard, [{
            ...
            value: function _createToolbar(position) {
                ...
                var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('').attr('type', 'button') : null;
                var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('').attr('type', 'button') : null;
