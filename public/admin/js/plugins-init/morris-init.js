    ...
    var dzMorris = function() {
        ...
        var donutChart = function() {
            Morris.Donut({
                ...
                resize: true,
                redraw: true,
                colors: ['#007ec6', 'rgb(255, 92, 0)', '#6418C3'],
                //responsive:true,
        ...
        var lineChart2 = function() {
            ...
            Morris.Area({
                ...
                pointSize: 3,
                fillOpacity: 0,
                pointStrokeColors: ['#FF3E3E', '#6418C3', '#007ec6'],
                behaveLikeLine: true,
                gridLineColor: 'transparent',
                lineWidth: 3,
                hideHover: 'auto',
                lineColors: ['rgb(255, 62, 62)', 'rgb(0, 171, 197)', '#007ec6'],
                resize: true
        ...
        var barChart = function() {
            if (jQuery('#morris_bar').length > 0) {
                ...
                Morris.Bar({
                    ...
                    ykeys: ['a', 'b', 'c'],
                    labels: ['A', 'B', 'C'],
                    barColors: ['#007ec6', '#6418C3', '#ff9f00'],
                    hideHover: 'auto',
                    gridLineColor: 'transparent',
                    resize: true,
                    barSizeRatio: 0.25,
        ...
        var areaChart = function() {
            ...
            Morris.Area({
                ...
                lineColors: ['#007ec6', 'rgb(16, 202, 147)', 'rgb(255, 92, 0)'],
                xkey: 'period',
                ykeys: ['smartphone', 'windows', 'mac'],
                labels: ['Phone', 'Windows', 'Mac'],
                pointSize: 0,
