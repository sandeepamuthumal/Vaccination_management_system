 ...
 var dzSparkLine = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(1, "rgb(9 102 142 / 51%)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(1, "rgb(9 102 142 / 51%)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(1, "rgb(9 102 142 / 51%)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgb(9 102 142 / 51%)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(1, "rgb(9 102 142 / 51%)");
