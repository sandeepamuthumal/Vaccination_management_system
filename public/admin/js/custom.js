 var Zenix = function() {
     ...
     var handleshowPass = function() {
         jQuery('.show-pass').on('click', function() {
             ...
             else if (jQuery('#user-password').attr('type') == 'password') {
                 jQuery('#user-password').attr('type', 'text');
             } else if (jQuery('#user-password').attr('type') == 'text') {
                 jQuery('#user-password').attr('type', 'password');
             }
             else if (jQuery('#cl-password').attr('type') == 'password') {
                 jQuery('#cl-password').attr('type', 'text');
             } else if (jQuery('#cl-password').attr('type') == 'text') {
                 jQuery('#cl-password').attr('type', 'password');
             }
         });
     }
